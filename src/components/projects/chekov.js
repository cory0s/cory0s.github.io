  ...
  <StaticQuery
    ...
    render={data => 
      <div className='checkov'>
          <h2>Chekov</h2>
          <div id="links">
            <a href="https://github.com/abc-s/201-final-project" target="_blank">Github</a>
            <a href="https://abc-s.github.io/201-final-project/lists.html" target="_blank">Deployed Site</a>
          </div>
